    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('1', 'very bad'), ('2', 'bad'), ('3', 'normal'), ('4', 'good'), ('5', 'very good'), ('6', 'showroom')], default=('3', 'normal'), max_length=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='TP2Q3.car')),
            ],
            options={
                'verbose_name': 'Bill',
